package com.baidu.gme.practice;
...
public class CustomLoadingView extends View {
    ...
    private Paint paint;
    //倒计时的时间
    private int countDownTimeTotal = 1500;
    // 总的倒计时默认是1.5秒 //view默认的长度和高度
    ...
    public CustomLoadingView(Context context, @Nullable AttributeSet attrs) {
        ...
        countDownTimeTotal = array.getInteger(R.styleable.CustomLoadingView_round_once_time,
                1500);
